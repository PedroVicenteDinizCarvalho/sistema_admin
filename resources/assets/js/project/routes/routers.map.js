...
import Projects from '../components/admin/pages/projects_modal/Projects'
import Clients from '../components/admin/pages/clients_modal/Clients'
...
export default [
    ...
    {path: '/entrar', component: LoginComponent, name: 'auth'},
    {
        ...
        children: [
            ...
            {path: 'projetos', component: Projects, name: 'projects'},
