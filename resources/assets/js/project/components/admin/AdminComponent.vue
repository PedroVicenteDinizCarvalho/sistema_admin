    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <ul class="nav navbar-nav navbar-right">
          ...
          <router-link v-if="me.name" class="nav-link" :to="{name: 'projects'}">Projetos</router-link>
          <router-link v-if="me.name" class="nav-link" :to="{name: 'clients'}">Clientes</router-link>
        </ul>
